...
{
windowhebergement=create_ajouter_mery();
...
void
on_Super3_clicked                      (GtkButton       *button,
                                        gpointer         user_data)
{
